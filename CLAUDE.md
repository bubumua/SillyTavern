# CLAUDE.md — SillyTavern Project Guide
...
| Module | Purpose |
|---|---|
| `scripts/openai.js` | Chat completion API handling (OpenAI, Claude, Gemini, etc.) — **284KB** |
...
| Route | Module | Purpose |
|---|---|---|
| `/api/backends/chat-completions` | `chat-completions.js` | Unified chat completion proxy (OpenAI, Claude, Gemini, etc.) |
...
| `/api/anthropic/*` | `anthropic.js` | Claude-specific endpoints |
...
OpenAI, Claude, OpenRouter, Google Gemini/Vertex AI, Mistral AI, Cohere, DeepSeek, Groq, xAI, Perplexity, AI21, Azure OpenAI, NanoGPT, AI/ML API, Pollinations, Moonshot, Fireworks, Chutes, ElectronHub, SiliconFlow, Custom OpenAI-compatible
...
| `claude/openai/gemini/ollama` | Per-provider settings |
